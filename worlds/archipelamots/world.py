...
class ArchipelamotsWorld(World):
    """
    Archipelamots est un super jeu de mots fléchés !!! Je l'ai fait avec mes petites mains (et des supers API open source)
    """
    ...
    web = web_world.ArchipelamotsWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    options_dataclass = archipelamots_options.ArchipelamotsOptions
    options: archipelamots_options.ArchipelamotsOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.ArchipelamotsItem:
